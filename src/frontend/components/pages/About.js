...
const About = () => {
  return (
    <div className="container text-center">
      ...
      <p>
        Not all wines are created equal and many wines can stray from the
        classical and regional definitions that the Court of Master Sommeliers
        uses in their evaluations. Wines in the $20-$30 dollar range will be
        more likely to fit the definitions used.
      </p>
      <p>
        Here are links to PDF files that will help you select wines that will
        work best.
      </p>
